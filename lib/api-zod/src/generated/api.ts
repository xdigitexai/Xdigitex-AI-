...
export const AdminCreateProviderResponse = zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "type": zod.string(),
  "status": zod.enum(['active', 'inactive']),
...
export const ListConversationsQueryParams = zod.object({
  ...
  "limit": zod.coerce.number().max(listConversationsQueryLimitMax).optional(),
...
export const ListConversationsResponse = zod.object({
  ...
  "server_id": zod.number().nullish(),
  "last_message_at": zod.coerce.date().optional(),
  "messages": zod.array(zod.record(zod.string(), zod.unknown())).optional(),
  "runs": zod.array(zod.object({
  "public_id": zod.string(),
  "status": zod.enum(['queued', 'running', 'waiting', 'completed', 'failed', 'cancelled', 'insufficient_credits']),
  "phase": zod.string(),
  ...
  "checkpoints": zod.array(zod.record(zod.string(), zod.unknown())).optional()
})).optional()
})),
  "limit": zod.number(),
  "offset": zod.number(),
...
export const CreateConversationMessageHeader = zod.object({
  "Idempotency-Key": zod.string().optional()
})

export const CreateConversationMessageBody = zod.object({
  "content": zod.string(),
  "continueFromRunId": zod.string().optional()
})
...
export const GetActiveConversationRunParams = zod.object({
  "conversationId": zod.coerce.string()
})

export const GetActiveConversationRunResponse = zod.union([zod.object({
  "public_id": zod.string(),
  "status": zod.enum(['queued', 'running', 'waiting', 'completed', 'failed', 'cancelled', 'insufficient_credits']),
  "phase": zod.string(),
  "events": zod.array(zod.record(zod.string(), zod.unknown())).optional(),
...
export const StreamAgentRunEventsParams = zod.object({
  "runId": zod.coerce.string()
})

export const StreamAgentRunEventsHeader = zod.object({
  "Last-Event-ID": zod.number().optional()
})

export const StreamAgentRunEventsResponse = zod.unknown()
...
export const ContinueAgentRunParams = zod.object({
  "runId": zod.coerce.string()
})

export const ContinueAgentRunHeader = zod.object({
  "Idempotency-Key": zod.string().optional()
})

export const ContinueAgentRunBody = zod.object({
  "mode": zod.enum(['continue', 'retry']).optional()
})

export const ContinueAgentRunResponse = zod.object({
  "public_id": zod.string(),
  "status": zod.enum(['queued', 'running', 'waiting', 'completed', 'failed', 'cancelled', 'insufficient_credits']),
  "phase": zod.string(),
  "events": zod.array(zod.record(zod.string(), zod.unknown())).optional(),
...
export const DecideAgentApprovalParams = zod.object({
  "approvalId": zod.coerce.string()
})

export const DecideAgentApprovalBody = zod.object({
  "decision": zod.enum(['approved', 'rejected', 'edited']),
  "editedInput": zod.record(zod.string(), zod.unknown()).optional()
})

export const DecideAgentApprovalResponse = zod.unknown()


export const GetLiveCreditsResponse = zod.unknown()
